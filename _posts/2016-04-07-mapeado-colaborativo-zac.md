...
Así pues, terminamos agradeciéndoles a José Ramon y Mapi su interés por el proyecto y su generosidad y contribución a su correcto desempeño, así como a Miguel Sevilla-Callejo, quien se ha mostrado interesado y colaborador en todo momento desde que anunciamos nuestras intenciones en la lista de correo de OpenStreetMap y a Alejandro Suárez, que se incorporó justamente tras la reunión y resulta una pieza clave en la comunidad OSM de Aragón y en el grupo. Sin todos ellos todo esto no sería posible.
